...
**Назначение**: Стили изображений в карточках услуг
...
**Назначение**: Прямоугольные элементы услуг

#### 30. EOFMouseReactive3.css
**Назначение**: Стили для реакций на мышь
...
*Для информации по JS модулям см. [JS_MODULES.md](./JS_MODULES.md)*